...
def obtener_sexo():
    sexo = str(input("Dime tu Genero. "))
    return sexo

def obtener_pais():
    pais = str(input("Dime tu pais. "))
    return pais
...
def mostrar_perfil(nombre, edad, sexo, pais, estatura_m, estatura_cm, num_amigos):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
...
mostrar_perfil(nombre, edad, sexo, pais, estatura_m, estatura_cm, num_amigos)
